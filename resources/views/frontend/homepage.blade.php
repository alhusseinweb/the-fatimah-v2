            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr1.jpg') }}" alt="تصوير الأعراس" class="img-fluid service-icon">
                        <h3>تصوير الأعراس</h3>
                ...
                <div class="col-md-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr2.jpg') }}" alt="تصوير المودلز" class="img-fluid service-icon">
                ...
                <div class="col-md-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr3.jpg') }}" alt="تصوير الحفلات والمناسبات" class="img-fluid service-icon">
