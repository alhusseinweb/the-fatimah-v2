...
<head>
    ...
    <title>{{ config('app.name', 'Fatimah Booking') }}</title>
    ...
    {{-- تضمين ملف CSS المخصص ( frontend.css) --}}
    ...
    <style>
        ...
        .hero-slide-item:nth-child(1) { background-image: url('{{ asset('images/slider/slider1.jpg') }}'); }
        .hero-slide-item:nth-child(2) { background-image: url('{{ asset('images/slider/slider2.jpg') }}'); }
        .hero-slide-item:nth-child(3) { background-image: url('{{ asset('images/slider/slider3.jpg') }}'); }
        ...
        /* Contact Section */
        .contact-background { background: url('{{ asset('images/contact-background.jpg') }}') no-repeat center center; background-size: cover; position: relative; padding-top: 5rem; padding-bottom: 5rem; width: 100%; margin: 0; padding-left: 0; padding-right: 0; z-index: 1; }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('login.otp.form') ? 'active' : '' }}" href="{{ route('login') }}">تسجيل الدخول</a>
                        </li>
                    @else
                         <li class="nav-item dropdown">
                             ...
                             <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                 <li><a class="dropdown-item" href="{{ route('customer.dashboard') }}">حسابي</a></li>
    ...
    {{-- (Hero Section, Services, Contact, Footer remain the same) --}}
                ...
                <div class="carousel-item active hero-slide-item">
                    <div class="carousel-caption d-flex align-items-center justify-content-center h-100">
                        <div class="text-center text-white hero-caption-content">
                            <img src="{{ asset('images/logo_w.png') }}" alt="Fatimah Ali Photography Logo" class="img-fluid hero-logo-in-caption mb-3">
            ...
            <div class="row">
                <div class="col-md-4 text-center mb-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr1.jpg') }}" alt="تصوير الأعراس" class="img-fluid rounded-circle service-icon mb-3">
                        <h3>تصوير الأعراس</h3>
                        <a href="{{ route('services.index') }}" class="btn btn-outline-primary mt-2">احجز الان</a>
                    </div>
                </div>
                <div class="col-md-4 text-center mb-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr2.jpg') }}" alt="تصوير المودلز" class="img-fluid rounded-circle service-icon mb-3">
                        <h3>تصوير المودلز</h3>
                        <a href="{{ route('services.index') }}" class="btn btn-outline-primary mt-2">احجز الان</a>
                    </div>
                </div>
                <div class="col-md-4 text-center mb-4">
                    <div class="service-item">
                        <img src="{{ asset('images/cr3.jpg') }}" alt="تصوير الحفلات" class="img-fluid rounded-circle service-icon mb-3">
                        <h3>تصوير الحفلات</h3>
                        <a href="{{ route('services.index') }}" class="btn btn-outline-primary mt-2">احجز الان</a>
                    </div>
                </div>
