                    ...
                    <div class="category-section fade-in" style="animation-delay: {{ $loop->index * 0.1 }}s;">
                        ...
                        <div class="row">
                            @foreach($category->services as $service)
                                <div class="col-md-6 col-lg-4 service-card-wrapper fade-in" style="animation-delay: {{ ($loop->parent->index * count($categories) + $loop->index + 1) * 0.05 }}s;">
                                    <div class="service-card">
                                        <div class="service-card-header">
                                            <h3 class="service-title">{{ $service->name_ar }}</h3>
                                            {{-- استخدام الدالة المساعدة لتحويل أرقام السعر --}}
                                        ...
                                        <div class="service-content">
                                            ...
                                            <div class="service-duration">
                                                <span class="duration-badge">
                                                    {{-- استخدام الدالة المساعدة لتحويل أرقام المدة --}}
