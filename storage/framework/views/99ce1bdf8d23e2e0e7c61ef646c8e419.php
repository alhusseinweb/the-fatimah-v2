...
<body>
    <section class="verify-section">
        <div class="verify-container">
            ...
            <p class="verify-subtitle">تم إرسال رمز التحقق إلى الرقم <strong dir="ltr"><?php echo e($mobile_number); ?></strong></p>

            
            <form method="POST" action="<?php echo e(route('register.verify')); ?>" id="otpForm">
                <?php echo csrf_field(); ?>
                 
                 <input type="hidden" name="mobile_number" value="<?php echo e($mobile_number); ?>">

                
                <div class="form-group mb-4">
                    <label for="otp" class="form-label">رمز التحقق</label>
                    
                    <input type="text" class="form-control otp-field <?php $__errorArgs = ['otp'];
...
unset($__errorArgs, $__bag); ?> <?php if(session('error') && (!isset($errors) || (isset($errors) && !$errors->has('otp')))): ?> is-invalid <?php endif; ?>"
                           id="otp" name="otp"
                           pattern="[0-9]{4}" 
                           maxlength="4" 
                           placeholder="• • • •" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(session('error') && (!isset($errors) || (isset($errors) && !$errors->has('otp')))): ?>
                ...
                <div class="resend-container">
                    ...
                    <div id="resendStatus" class="mt-1"></div> 
                </div>
            ...
            if (resendBtn) {
                resendBtn.addEventListener('click', function() {
                    if (!this.disabled) {
                        ...
                        fetch('<?php echo e(route("register.resend.otp")); ?>', {
                            method: 'POST',
                            headers: {
                            ...
                            body: JSON.stringify({
                                mobile_number: '<?php echo e($mobile_number); ?>' // استخدام الرقم من Blade
                            })
                        })
...
</html><?php /**PATH C:\laragon\www\fatimah-booking-system\resources\views/auth/register-verify.blade.php ENDPATH**/ ?>