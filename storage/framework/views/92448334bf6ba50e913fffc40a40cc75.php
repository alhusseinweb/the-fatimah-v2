...
<div class="services-page-wrapper">
    <div class="container">
        ...
        <?php if($categories->isEmpty() || $categories->flatMap(fn($category) => $category->services)->isEmpty()): ?>
                    ...
                    <div class="category-section fade-in" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s;">
                        ...
                        <div class="row">
                            <?php $__currentLoopData = $category->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-lg-4 service-card-wrapper fade-in" style="animation-delay: <?php echo e(($loop->parent->index * ($categories->count()) + $loop->index) * 0.07 + 0.1); ?>s;">
                                    <div class="service-card">
                                        ...
                                        <div class="service-content">
                                            ...
                                            <div class="service-price-box-new">
                                                <?php echo e(toArabicDigits(number_format($service->price_sar, 0))); ?> ريال
                                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mustafa\.gemini\antigravity\scratch\static\the-fatimah-old\resources\views/frontend/services/index.blade.php ENDPATH**/ ?>