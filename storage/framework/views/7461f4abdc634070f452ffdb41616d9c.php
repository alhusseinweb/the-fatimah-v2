...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow-sm mb-4 border-0">
        <div class="card-header bg-white py-3">
            <h6 class="m-0 fw-bold text-primary">قائمة الحجوزات الواردة <?php if(request('status') && isset($statuses[request('status')])): ?> - (<?php echo e($statuses[request('status')]); ?>) <?php elseif(request('status')): ?> - (<?php echo e(request('status')); ?>) <?php endif; ?></h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="card booking-card h-100 shadow-sm border-0">
                            <div class="card-header d-flex justify-content-between align-items-center bg-light-subtle">
                                <h6 class="mb-0 fw-bold small">
                                    <i class="fas fa-user me-1"></i> <?php echo e($booking->user?->name ?? 'غير محدد'); ?>
                            ...
                            <div class="card-body pb-2">
                                <p class="mb-2 text-dark">
                                    ...
                                    <?php echo e($booking->service?->name_ar ?? 'غير محدد'); ?>
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-between align-items-center border-top-dashed pt-2">
                                <span class="status-pill <?php echo e($booking->status_badge_class); ?>">
                                    <?php echo e($booking->status_label); ?>

                                </span>
                                <a href="<?php echo e(route('admin.bookings.show', $booking->id)); ?>" class="btn btn-outline-primary btn-sm" title="عرض التفاصيل">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mustafa\.gemini\antigravity\scratch\static\the-fatimah-old\resources\views/admin/bookings/index.blade.php ENDPATH**/ ?>