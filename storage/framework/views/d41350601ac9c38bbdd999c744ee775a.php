        ...
        <nav id="sidebarMenu" class="sidebar collapse d-lg-block bg-white shadow-sm">
            <div class="sidebar-sticky">
                 <ul class="nav flex-column">
                     ...
                     <li class="nav-item">
                         <a class="nav-link <?php echo e(request()->routeIs('admin.add_on_services.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.add_on_services.index')); ?>">
                     ...
                     <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.manual-booking.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.manual-booking.create')); ?>">
                     ...
                     <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.settings.sms.edit') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.sms.edit')); ?>">
...
<?php /**PATH C:\Users\mustafa\.gemini\antigravity\scratch\static\the-fatimah-old\resources\views/layouts/admin.blade.php ENDPATH**/ ?>