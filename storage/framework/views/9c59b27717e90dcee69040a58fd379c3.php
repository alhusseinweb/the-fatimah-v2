                ...
                <div class="card-body">
                    <div>
                        ...
                        <div class="h5 mb-0 fw-bold">
                         ...
                         <?php if(isset($smsMonthlyLimit) && $smsMonthlyLimit > 0 && $currentMonthSmsCount < $smsMonthlyLimit): ?>
                            <small class="text-muted">المتبقي: <?php echo e($smsMonthlyLimit - $currentMonthSmsCount); ?></small>
                         <?php elseif(isset($smsMonthlyLimit) && $smsMonthlyLimit > 0 && $currentMonthSmsCount >= $smsMonthlyLimit): ?>
    ...
    <div class="row g-4 mt-2">
        <div class="col-lg-6">
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body pt-2">
                    <?php if(isset($failedOrUnpaidInvoices) && $failedOrUnpaidInvoices->count() > 0): ?>
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $failedOrUnpaidInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('admin.invoices.show', $invoice->id)); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center flex-wrap px-2 py-2">
                                    <div class="mb-1 mb-md-0">
                                        <span class="fw-bold">فاتورة #<?php echo e($invoice->invoice_number); ?></span>
                                        <small class="text-muted ms-2">(<?php echo e($invoice->booking?->user?->name ?? 'عميل غير معروف'); ?>)</small>
                                        <small class="text-muted d-block d-md-inline ms-md-2"> - <?php echo e(\Carbon\Carbon::parse($invoice->created_at)->translatedFormat('d M Y')); ?></small>
                                    </div>
                                    <div class="text-end">
                                        <span class="me-2 fw-bold"><?php echo e(number_format($invoice->amount, 2)); ?> <?php echo e($invoice->currency_symbol_short ?? $invoice->currency); ?></span>
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body pt-2">
                    <?php if(isset($partiallyPaidInvoices) && $partiallyPaidInvoices->count() > 0): ?>
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $partiallyPaidInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('admin.invoices.show', $invoice->id)); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center flex-wrap px-2 py-2">
                                    <div class="mb-1 mb-md-0">
                                        <span class="fw-bold">فاتورة #<?php echo e($invoice->invoice_number); ?></span>
                                        <small class="text-muted ms-2">(<?php echo e($invoice->booking?->user?->name ?? 'عميل غير معروف'); ?>)</small>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\fatimah-booking-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>